...
"""
uptime_job_parallel_once_json.py
- Run uptime test case from genie_uptime_parallel_once_json_aetest module
- Testcase per device
...
def main(runtime) -> None:
    ...
    testscript = str((SCRIPT_DIR / "genie_uptime_parallel_once_json_aetest.py").resolve())
